...
namespace LearnAjaxx2.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,productName,purchasePrice,salesPrice,supplierId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,productName,purchasePrice,salesPrice,supplierId")] Product product)
        {
            if (ModelState.IsValid)
            {
